...
- [**Argument Analyst**](#argument-analyst): Evaluate the reading's central claims and reasoning
- [**Concept Keeper**](#concept-keeper): Identify and define key concepts and terms
...
1. In Canvas, under the "People" tab, check which Reading Response group you are assigned to in the "Groups" tab.
...
<h2 id="concept-keeper">Concept Keeper</h2>
...
<h2 id="design-translator">Design Translator</h2>
